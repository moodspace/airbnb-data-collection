...
GRANT
SELECT ON ALL TABLES IN SCHEMA PUBLIC TO reader;
...
GRANT
SELECT ON ALL TABLES IN SCHEMA gis TO reader;

GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA gis TO reader;

GRANT
SELECT ON ALL TABLES IN SCHEMA publish TO reader;
...
GRANT USAGE,
SELECT ON ALL SEQUENCES IN SCHEMA PUBLIC TO editor;
